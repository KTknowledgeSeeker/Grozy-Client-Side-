...
class PlayerActivity() : AppCompatActivity() {
    ...
    private fun playInFullscreen(enable: Boolean){
        if (enable){
            ...
            binding.recipeOptionLl.visibility = View.GONE
            portrait = false
        }
        else{
            ...
            binding.recipeOptionLl.visibility = View.VISIBLE
            portrait = true
        }
    }
    ...
    override fun onPictureInPictureModeChanged(isInPictureInPictureMode: Boolean, newConfig: Configuration?) {
        showToast("onPictureInPictureModeChanged")
        if(isInPictureInPictureMode){
            ...
            if (onStopstatus){
                ...
                if(pipMode == 1) {
                    ...
                    Toast.makeText(this@PlayerActivity, "called", Toast.LENGTH_SHORT).show()
